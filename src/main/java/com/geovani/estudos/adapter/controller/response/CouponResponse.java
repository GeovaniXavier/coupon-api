package com.geovani.estudos.adapter.controller.response;
...
public record CouponResponse(
        ...
        @Schema(description = "Data de expiração no formato ISO-8601", example = "2027-12-31T23:59:59Z")
    ...
    public static CouponResponse fromDomain(final Coupon coupon) {
